...
//                    Charsets::UTF8,
//                    new DataValueVarChar(var_default, strlen(var_default),
//                    100));
...
//                    Charsets::UTF8,
//                    new DataValueVarChar(fix_default, strlen(var_default),
//                    100));
...
//   BOOST_TEST(vct_ip[1]._vctCol[0].colPos == 1);
...
//   BOOST_TEST(vct_ip[2]._vctCol[0].colPos == 2);
//   BOOST_TEST(vct_ip[2]._vctCol[1].colName == "c4");
//   BOOST_TEST(vct_ip[2]._vctCol[1].colPos == 3);

//   BOOST_TEST(ptable.GetIndexType("c2_unique") == IndexType::UNIQUE);
...
//   BOOST_TEST(vct_col[2].GetMaxLength() == -1);
...
//   BOOST_TEST(vct_col[3].GetMaxLength() == 50);
...
//   BOOST_TEST(ptable2.GetIndexType("c3_c4_non_unique") ==
...
//   BOOST_TEST(col->IsNullable() == true);
//   BOOST_TEST(col->GetMaxLength() == 50);
//   BOOST_TEST(col->GetInitVal() == -1);
//   BOOST_TEST(col->GetIncStep() == -1);
//   BOOST_TEST(col->GetCharset() == Charsets::UTF8);
...
//   BOOST_TEST(vct_ip2[1]._vctCol[0].colPos == 1);
...
//   BOOST_TEST(vct_ip2[2]._vctCol[0].colPos == 2);
//   BOOST_TEST(vct_ip2[2]._vctCol[1].colName == "c4");
//   BOOST_TEST(vct_ip2[2]._vctCol[1].colPos == 3);
// }
