...
//   const string FILE_NAME = ROOT_PATH + "/testLeafPage" + StrMSTime() +
...
//   LeafPage *lp = (LeafPage *)indexTree->GetPage(0, PageType::LEAF_PAGE,
//   true);
...
//     lpNext = (LeafPage *)indexTree->GetPage(lNext, PageType::LEAF_PAGE,
//     true); int rn = lpNext->GetRecordNumber(); BOOST_TEST(rn > 0);
...
//     lpNext = (LeafPage *)indexTree->GetPage(lNext, PageType::LEAF_PAGE,
//     true); BOOST_TEST(lpNext->GetRecordNumber() > 0U);
