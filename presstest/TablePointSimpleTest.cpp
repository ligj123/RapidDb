...
//       int currVal = cnt % recNum + startRec;
//       if (currVal < startRec) {
//         currVal = startRec;
//       }
...
//           } else {
//             arrResult[currVal] -= 1;
//             SessionPool::AddStatement(tid, vctSessId[i], cnt, 5,
//             UPDATE_STMT2,
//                                       move(vctRow), &vctResult[i]);
//           }
//         } else {
...
//                     int totalOpTimes, bool bExclusive) {
...
//   MVector<IndexTask *> vTask =
//   table->GetTableTaskMgr()->GetVctIndexTasks()[0]; stringstream ss; ss <<
//   "Action Number:  "; for (size_t i = 0; i < vTask.size(); i++) {
