...
public:
  PersistColumn(){};
  PersistColumn(const std::string &name, uint32_t pos, DataType dataType,
                const string &comments, bool bNullable, uint32_t maxLen,
                uint32_t incStep, utils::Charsets charset,
