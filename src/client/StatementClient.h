...
// protected:
//   // If automate transaction, it equal transaction id. If manual transaction,
//   it
...
//   // The number of tiny taks. One statement maybe splite serveral tiny tasks
//   to
...
//   // statement; True , no transaction incoming and need this statement to
//   create
//   // a new transaction.
