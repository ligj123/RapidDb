...
protected:
  ...
  // public StatementTask(ActionType actionType, Statement statement,
  // List<IDataValue[]> lstArDv) { 	this.actionType = actionType;
  // this.statement =
  // statement; 	this.lstArDv = lstArDv; 	this.taskId =
  // atomicId.getAndIncrement();
  //}

  // public StatementTask(ActionType actionType, Statement statement,
  // IDataValue[] arDv) { 	this.actionType = actionType; 	this.statement =
  // statement; 	lstArDv = new ArrayList<>(); 	lstArDv.add(arDv);
