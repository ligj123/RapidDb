...
// public:
//   ExprTableSelect(PhysTable *physTable, ExprTable *destTable, ExprLogic
//   *where,
//                   SelIndex *selIndex, MVector<OrderCol> *vctOrder,
//                   bool bDistinct, int offset, int rowCount, bool
//                   bCacheResult, VectorDataValue *paraTmpl, ExprStatement
//                   *parent)
